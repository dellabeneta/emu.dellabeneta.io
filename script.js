const PLATFORMS = [
  ...
  },
  {
    ...
    games: [
      ...
      { title: "Donkey Kong Country 2: Diddy's Kong Quest", displayTitle: "Donkey Kong Country 2", year: "1995", file: "donkey-kong-country-2-diddy's-kong-quest.sfc" },
      { title: "Donkey Kong Country 3: Dixie Kong's Double Trouble!", displayTitle: "Donkey Kong Country 3", year: "1996", file: "donkey-kong-country-3-dixie-kong's-double-trouble!.sfc" },
      ...
      { title: "R-Type III", year: "1993", file: "r-type-iii.sfc" },
      ...
      { title: "Street Fighter II Turbo", year: "1992", file: "street-fighter-ii-turbo.sfc" },
      ...
      { title: "Super Mario RPG", year: "1996", file: "super-mario-rpg-legend-of-the-seven-stars.sfc" },
      { title: "Super Metroid", year: "1994", file: "super-metroid.sfc" },
      { title: "Super Punch-Out!!", year: "1994", file: "super-punch-out!!.sfc" },
      { title: "Super Street Fighter II", year: "1993", file: "super-street-fighter-ii-the-new-challengers.sfc" },
      { title: "TMNT IV: Turtles in Time", year: "1992", file: "teenage-mutant-ninja-turtles-iv-turtles-in-time.sfc" },
      ...
      { title: "Zombies Ate My Neighbors", year: "1993", file: "zombies-ate-my-neighbors.sfc" }
  ...
  },
  {
    ...
    games: [
      { title: "Baku Baku Animal", year: "1995", file: "baku-baku-animal.sms" },
      { title: "Castle of Illusion", year: "1990", file: "castle-of-illion-starring-mickey-moe.sms" },
      { title: "Desert Strike", year: "1993", file: "desert-strike.sms" },
      { title: "Dynamite Headdy", year: "1994", file: "dynamite-headdy.sms" },
      { title: "Fantasy Zone II", year: "1987", file: "fantasy-zone-ii-the-tears-of-opa-opa.sms" },
      { title: "Fantasy Zone", year: "1986", file: "fantasy-zone.sms" },
      { title: "Ghouls 'n Ghosts", year: "1988", file: "ghouls'n-ghosts.sms" },
      { title: "Golden Axe", year: "1990", file: "golden-axe.sms" },
      { title: "Golden Axe Warrior", year: "1991", file: "golden-axe-warrior.sms" },
      { title: "Land of Illusion", year: "1992", file: "land-of-illion-starring-mickey-moe.sms" },
      { title: "Lemmings", year: "1991", file: "lemmings.sms" },
      { title: "Master of Darkness", year: "1992", file: "master-of-darkness.sms" },
      { title: "Mortal Kombat II", year: "1994", file: "mortal-kombat-ii.sms" },
      { title: "Mortal Kombat", year: "1993", file: "mortal-kombat.sms" },
      { title: "Operation Wolf", year: "1988", file: "operation-wolf.sms" },
      { title: "OutRun", year: "1987", file: "outrun.sms" },
      { title: "Phantasy Star", year: "1987", file: "phantasy-star.sms" },
      { title: "Prince of Persia", year: "1992", file: "prince-of-persia.sms" },
      { title: "Rainbow Islands", year: "1990", file: "rainbow-islands.sms" },
      { title: "R-Type", year: "1988", file: "r-type.sms" },
      { title: "Shinobi", year: "1988", file: "shinobi.sms" },
      { title: "Sonic Chaos", year: "1993", file: "sonic-chaos.sms" },
      { title: "Sonic the Hedgehog 2", year: "1992", file: "sonic-the-hedgehog-2.sms" },
      { title: "Sonic the Hedgehog", year: "1991", file: "sonic-the-hedgehog.sms" },
      { title: "Street Fighter II", year: "1993", file: "street-fighter-ii.sms" },
      { title: "Wonder Boy III: The Dragon's Trap", year: "1989", file: "wonder-boy-iii-the-dragon's-trap.sms" },
      { title: "Wonder Boy in Monster Land", year: "1988", file: "wonder-boy-in-monster-land.sms" },
      { title: "Wonder Boy", year: "1986", file: "wonder-boy.sms" },
      { title: "Ys: The Vanished Omens", year: "1988", file: "ys-the-vanished-omens.sms" },
      { title: "Zillion", year: "1987", file: "zillion.sms" }
  ...
  },
  {
    ...
    games: [
      ...
      { title: "Comix Zone", year: "1995", file: "comix-zone.md" },
      { title: "Contra: Hard Corps", year: "1994", file: "contra-hard-corps.md" },
      { title: "Earthworm Jim", year: "1994", file: "earthworm-jim.md" },
      { title: "Ecco the Dolphin", year: "1992", file: "ecco-the-dolphin.md" },
      { title: "Ecco: The Tides of Time", year: "1994", file: "ecco-the-tides-of-time.md" },
      { title: "Fatal Fury 2", year: "1993", file: "fatal-fury-2.md" },
      { title: "Fatal Fury", year: "1992", file: "fatal-fury.md" },
      { title: "Ghouls 'n Ghosts", year: "1989", file: "ghouls'n-ghosts.md" },
      { title: "Golden Axe III", year: "1993", file: "golden-axe-iii.md" },
      { title: "Golden Axe", year: "1989", file: "golden-axe.md" },
      { title: "Gunstar Heroes", year: "1993", file: "gunstar-heroes.md" },
      { title: "Jurassic Park", year: "1993", file: "jurassic-park.md" },
      { title: "Landstalker", year: "1992", file: "landstalker.md" },
      { title: "Lemmings", year: "1991", file: "lemmings.md" },
      { title: "Mega Bomberman", year: "1993", file: "mega-bomberman.md" },
      { title: "Monster World IV", year: "1994", file: "monster-iv.md" },
      ...
      { title: "NHL '94", year: "1993", file: "nhl-'94.md" },
      { title: "Phantasy Star II", year: "1989", file: "phantasy-star-ii.md" },
      { title: "Phantasy Star IV", year: "1993", file: "phantasy-star-iv.md" },
      { title: "Ristar", year: "1995", file: "ristar.md" },
      { title: "Road Rash 3", year: "1995", file: "road-rash-3.md" },
      { title: "Road Rash II", year: "1992", file: "road-rash-ii.md" },
      { title: "Road Rash", year: "1991", file: "road-rash.md" },
      { title: "Rocket Knight Adventures", year: "1993", file: "rocket-knight-adventures.md" },
      { title: "Samurai Shodown", year: "1994", file: "samurai-shodown.md" },
      { title: "Shining Force", year: "1992", file: "shining-force.md" },
      { title: "Shinobi III: Return of the Ninja Master", year: "1993", file: "shinobi-iii-return-of-the-ninja-master.md" },
      { title: "Sonic & Knuckles", year: "1994", file: "sonic-&-knuckles.md" },
      ...
      { title: "Splatterhouse 2", year: "1992", file: "splatterhoe-2.md" },
      { title: "Splatterhouse 3", year: "1993", file: "splatterhoe-3.md" },
      ...
      { title: "Streets of Rage 3", year: "1994", file: "streets-of-rage-3.md" },
      { title: "Super Street Fighter II", year: "1993", file: "super-street-fighter-ii.md" },
      { title: "The Lion King", year: "1994", file: "the-lion-king.md" },
      { title: "The Revenge of Shinobi", year: "1989", file: "the-revenge-of-shinobi.md" },
      { title: "ToeJam & Earl", year: "1991", file: "toejam-and-earl.md" },
      { title: "ToeJam & Earl in Panic on Funkotron", year: "1993", file: "toejam-&-earl-in-panic-on-funkotron.md" },
      { title: "Vectorman 2", year: "1996", file: "vectorman-2.md" },
      { title: "Vectorman", year: "1995", file: "vectorman.md" },
      { title: "X-Men 2: Clone Wars", year: "1995", file: "x-men-2-clone-wars.md" },
      { title: "X-Men", year: "1993", file: "x-men.md" }
  ...
  },
  {
    ...
    games: [
      ...
      { title: "TMNT: Arcade Game", year: "1989", file: "tmnt22pu.zip" },
      { title: "TMNT: Arcade Game (JP)", year: "1989", file: "tmnt2pj.zip" },
      { title: "X-Men", year: "1992", file: "xmen2pa.zip" },
      { title: "Contra", year: "1987", file: "contra.zip" },
      { title: "Super Contra", year: "1988", file: "scontra.zip" },
      { title: "After Burner II", year: "1987", file: "aburner2.zip" },
      { title: "OutRun", year: "1986", file: "outrun.zip" },
      { title: "Hang-On", year: "1985", file: "hangon.zip" },
      ...
      { title: "Galaxian", year: "1979", file: "galaxian.zip" },
      { title: "Dig Dug", year: "1982", file: "digdug.zip" },
      { title: "Frogger", year: "1981", file: "frogger.zip" },
      { title: "Donkey Kong", year: "1981", file: "dkong.zip" },
      { title: "Donkey Kong Jr", year: "1982", file: "dkongjr.zip" },
      { title: "Mario Bros", year: "1983", file: "mario.zip" },
      { title: "Space Invaders", year: "1978", file: "invaders.zip" },
      { title: "Asteroids", year: "1979", file: "asteroid.zip" },
      { title: "Missile Command", year: "1980", file: "missile.zip" },
      { title: "Centipede", year: "1980", file: "centiped.zip" },
      { title: "Gradius III", year: "1989", file: "gradius3.zip" },
      { title: "R-Type", year: "1987", file: "rtype.zip" },
      { title: "1942", year: "1984", file: "1942.zip" },
      { title: "1943", year: "1987", file: "1943.zip" },
      { title: "Commando", year: "1985", file: "commando.zip" },
      { title: "Double Dragon", year: "1987", file: "ddragon.zip" },
      { title: "Double Dragon II", year: "1988", file: "ddragon2.zip" },
      { title: "Bubble Bobble", year: "1986", file: "bublbobl.zip" },
      { title: "Snow Bros", year: "1990", file: "snowbros.zip" },
      { title: "Kung-Fu Master", year: "1984", file: "kungfum.zip" },
      { title: "Punch-Out!!", year: "1983", file: "punchout.zip" },
      { title: "Track & Field", year: "1983", file: "trackfld.zip" },
      { title: "Q*bert", year: "1982", file: "qbert.zip" },
      { title: "Joust", year: "1982", file: "joust.zip" },
      { title: "Defender", year: "1981", file: "defender.zip" },
      { title: "Rampage", year: "1986", file: "rampage.zip" },
      ...
      { title: "Captain America", year: "1991", file: "captaven.zip" },
      { title: "Elevator Action", year: "1983", file: "elevator.zip" },
      { title: "Arkanoid", year: "1986", file: "arkanoid.zip" },
      { title: "Burger Time", year: "1982", file: "btime.zip" },
      { title: "Popeye", year: "1982", file: "popeye.zip" },
      { title: "Splatter House", year: "1988", file: "splatter.zip" },
      { title: "Bad Dudes", year: "1988", file: "baddudes.zip" },
      { title: "Ghouls 'n Ghosts", year: "1988", file: "gng.zip" },
      { title: "Parodius DA!", year: "1990", file: "parodius.zip" },
      { title: "Aero Fighters", year: "1992", file: "aerofgt.zip" },
      { title: "Asterix", year: "1992", file: "asterix.zip" },
      { title: "Chase H.Q.", year: "1988", file: "chasehq.zip" }
    ]
  },
  {
    name: "Capcom CPS-1",
    ...
    games: [
      { title: "Street Fighter II", year: "1991", file: "sf2.zip" },
      { title: "Street Fighter II' CE", year: "1992", file: "sf2ce.zip" },
  ...
  },
  {
    ...
    games: [
      ...
      { title: "Marvel vs. Capcom", year: "1998", file: "mvsc.zip" },
      { title: "X-Men vs. SF", year: "1996", file: "xmvsf.zip" },
      { title: "Marvel Super Heroes", year: "1995", file: "msh.zip" },
      { title: "X-Men: COTA", year: "1994", file: "xmcota.zip" },
      { title: "Darkstalkers", year: "1994", file: "dstlk.zip" },
      ...
      { title: "Dungeons & Dragons: SOM", year: "1996", file: "ddsom.zip" },
      { title: "Dungeons & Dragons: TOD", year: "1994", file: "ddtod.zip" },
      { title: "Super Puzzle Fighter II T", year: "1996", file: "spf2t.zip" },
      { title: "Super Street Fighter II T", year: "1994", file: "ssf2t.zip" },
      ...
      { title: "Super Gem Fighter", year: "1997", file: "sgemf.zip" },
  ...
  },
  {
    ...
    games: [
      { title: "Street Fighter III: 3rd Strike", year: "1999", file: "sfiii3.zip" },
      { title: "Street Fighter III: 2nd Impact", year: "1997", file: "sfiii2.zip" },
  ...
  },
  {
    ...
    games: [
      ...
      { title: "KOF 98", year: "1998", file: "kof98.zip" },
      { title: "KOF 97", year: "1997", file: "kof97.zip" },
      { title: "KOF 94", year: "1994", file: "kof94.zip" },
      { title: "KOF 99", year: "1999", file: "kof99.zip" },
      { title: "KOF 2002", year: "2002", file: "kof2002.zip" },
      { title: "Garou: Mark of the Wolves", year: "1999", file: "garou.zip" },
      { title: "Samurai Shodown II", year: "1994", file: "samsho2.zip" },
      { title: "Samurai Shodown IV", year: "1996", file: "samsho4.zip" },
      ...
      { title: "Nightmare in the Dark", year: "2000", file: "ncommand.zip" },
      { title: "Sengoku 3", year: "2001", file: "sengoku3.zip" },
      { title: "Matrimelee", year: "2003", file: "matrim.zip" },
      { title: "Last Resort", year: "1992", file: "lresort.zip" },
      { title: "Rage of the Dragons", year: "2002", file: "rotd.zip" },
      { title: "Waku Waku 7", year: "1996", file: "wakuwak7.zip" },
      { title: "Karnov's Revenge", year: "1994", file: "karnovr.zip" },
      { title: "Street Hoop", year: "1994", file: "strhoop.zip" },
      { title: "Double Dragon", year: "1995", file: "doubledr.zip" },
      { title: "Pulstar", year: "1995", file: "pulstar.zip" },
      { title: "Breakers Revenge", year: "1998", file: "breakrev.zip" },
      ...
      { title: "Puzzle Bobble 2", year: "1995", file: "pbobbl2n.zip" },
      { title: "Twinkle Star Sprites", year: "1996", file: "twinspri.zip" },
      { title: "Art of Fighting 2", year: "1994", file: "aof2.zip" },
      { title: "Art of Fighting 3", year: "1996", file: "aof3.zip" },
      { title: "Fatal Fury Special", year: "1993", file: "fatfursp.zip" },
      { title: "Real Bout Fatal Fury 2", year: "1998", file: "rbff2.zip" },
      { title: "NAM-1975", year: "1990", file: "nam1975.zip" },
      { title: "Kabuki Klash", year: "1995", file: "kabukikl.zip" },
      { title: "Spinmaster", year: "1993", file: "spinmast.zip" },
      { title: "Super Dodge Ball", year: "1996", file: "sdodgeb.zip" },
      { title: "Top Hunter", year: "1994", file: "tophuntr.zip" },
      { title: "Magician Lord", year: "1990", file: "maglord.zip" },
      { title: "Neo Bomberman", year: "1997", file: "neobombe.zip" },
      { title: "League Bowling", year: "1990", file: "lbowling.zip" },
      { title: "Mutation Nation", year: "1992", file: "mutnat.zip" },
      { title: "Magical Drop III", year: "1997", file: "magdrop3.zip" },
      { title: "Viewpoint", year: "1992", file: "viewpoin.zip" }
    ]
  }
];
